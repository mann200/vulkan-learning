...
public:
	...
	void Init(float width, float height) {
		...
		// 设置标题背景色
		style.Colors[ImGuiCol_TitleBg] = ImVec4(0.2f, 0.2f, 0.6f, 0.8f);          // 深蓝色背景
		style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.1f, 0.1f, 0.5f, 0.9f);    // 更深的激活状态背景
    
		// 设置菜单栏背景色
		style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.3f, 0.3f, 0.7f, 0.5f);        // 较浅的蓝色背景
    
		// 设置头部背景色
		style.Colors[ImGuiCol_Header] = ImVec4(0.2f, 0.2f, 0.6f, 0.5f);           // 深蓝色头部背景
    
		// 设置复选标记颜色
		style.Colors[ImGuiCol_CheckMark] = ImVec4(0.0f, 1.0f, 0.0f, 1.0f);        // 绿色复选标记
    
		// 设置文本颜色
		style.Colors[ImGuiCol_Text] = ImVec4(1.0f, 1.0f, 1.0f, 1.0f);             // 白色文本
    
		// 设置窗口背景色
		style.Colors[ImGuiCol_WindowBg] = ImVec4(0.1f, 0.1f, 0.2f, 0.9f);         // 深灰色背景
    
		// 设置按钮颜色
		style.Colors[ImGuiCol_Button] = ImVec4(0.2f, 0.5f, 0.8f, 0.6f);           // 蓝色按钮
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.3f, 0.6f, 0.9f, 0.7f);    // 鼠标悬停时的按钮颜色
		style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.1f, 0.4f, 0.7f, 0.8f);     // 按下时的按钮颜色
